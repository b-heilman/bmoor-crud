...
describe('src/mapper.js', function(){
	it('should properly instantiate', function(){
		...
		expect(table1.reduceConnections())
		.to.deep.equal([
		...
		expect(table1.reduceConnectors())
		.to.deep.equal({
		...
		expect(table2.reduceConnections())
		.to.deep.equal([
		...
		expect(table2.reduceConnectors())
		.to.deep.equal({
		...
		expect(table3.reduceConnections())
		.to.deep.equal([
		...
		expect(table3.reduceConnectors())
		.to.deep.equal({
		...
		expect(table4.reduceConnections())
		.to.deep.equal([
		...
		expect(table4.reduceConnectors())
		.to.deep.equal({
	...
	describe('::getRelationships', function(){
		...
		it('pull in a singlar value', function(){
			...
			expect(mapper.getRelationships(model1.name))
			.to.deep.equal([{
				name: 'test-2',
				local: 'zwei',
				remote: 'id',
			...
			expect(mapper.getRelationships(model3.name))
			.to.deep.equal([{
				name: 'test-2',
				local: 'zwei',
				remote: 'id',
			...
			expect(mapper.getRelationships(model2.name))
			.to.deep.equal([{
				name: 'test-1',
				local: 'id',
				remote: 'zwei',
	...
	describe('::getRelationship', function(){
		...
		it('pull in a singlar value', function(){
			...
			expect(mapper.getRelationship(model1.name, 'test-2'))
			.to.deep.equal({
				name: 'test-2',
				local: 'zwei',
				remote: 'id',
			...
			expect(mapper.getRelationship(model1.name, 'test-3'))
			.to.deep.equal({
				name: 'test-3',
				local: 'drei',
				remote: 'id',
			...
			expect(mapper.getRelationship(model1.name, 'test-3', 'drei'))
			.to.deep.equal({
				name: 'test-3',
				local: 'drei',
				remote: 'id',
			...
			expect(mapper.getRelationship(model1.name, 'test-3', 'fier'))
			.to.deep.equal({
				name: 'test-3',
				local: 'fier',
				remote: 'id',
			...
			expect(mapper.getRelationship(model1.name, 'test-4'))
			.to.equal(null);
		});
	});
